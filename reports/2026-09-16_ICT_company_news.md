...
### 1. 鴻海精密工業 / Foxconn
- 今日重點：未見 48 小時內新增且可直接驗證的設廠或投資公告。
- 代表查詢：鴻海 設廠 AI 伺服器、Foxconn AI server factory investment Europe、Hon Hai Ohio Texas manufacturing localization。
- 海外設廠／國際布局訊號：無新增；延續追蹤 Ohio、Texas、Wisconsin、California 與法國先進封裝布局。
- 對 TEEMA 意涵：仍應追問 AI 伺服器機櫃、FOWLP、衛星通訊零組件對電力、用地與在地供應商的需求。

### 2. 康舒科技 / AcBel Polytech
- 今日重點：未見重大新動態。
- 代表查詢：康舒 電源 海外設廠、AcBel Polytech power supply factory investment、OmniOn Power Europe facility。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：持續追蹤資料中心電源、BBU 與歐洲能源設備服務據點需求。

### 3. 英業達 / Inventec
- 今日重點：未見重大新動態。
- 代表查詢：英業達 AI伺服器 新廠、Inventec Brno Czech server factory、Inventec AI server manufacturing capacity。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：後續需查 Brno 廠是否有 AI 伺服器機櫃級組裝、接電或人力擴編訊號。

### 4. 光寶科技 / LITEON
- 今日重點：未見 48 小時內新設廠公告；9 月上旬美國製造資本支出及波蘭 DCX 策略投資仍為追蹤主軸。
- 代表查詢：光寶 德州 電源 資本支出、LITEON McKinney power supply factory、LITEON data center power liquid cooling。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：訪談應聚焦德州基地用電、客戶在地化交付、液冷整合與台越美分工。

### 5. 東元電機 / TECO
- 今日重點：未見新增公告；9/13 媒體報導東元參與美國 Conduit Pharmaceuticals 合資 AI 資料中心公司，但超出本次 48 小時窗，列待後續複核。
- 代表查詢：東元 AIDC 資料中心 美國、TECO AI data center joint venture、TECO transformer MDC Malaysia。
- 海外設廠／國際布局訊號：待複核；非本輪寫入項。
- 對 TEEMA 意涵：AIDC 工程、MDC、變壓器與馬來西亞匯流排產線應列訪談題綱。

### 6. 美律實業 / Merry Electronics
- 今日重點：未見重大新動態。
- 代表查詢：美律 SEAS Norway acoustic factory、Merry Electronics Europe acoustic manufacturing、SEAS Fabrikker investment。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：後續以挪威 SEAS 技術與歐洲聲學客戶需求為主。

### 7. 環鴻科技 / USI
- 今日重點：未見重大新動態。
- 代表查詢：環鴻 Asteelflash Europe EMS、USI Asteelflash factory investment France Poland、Universal Scientific Industrial automotive electronics Europe。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：持續追蹤歐洲 EMS、車用與工業電子在地化訂單。

### 8. 台達電子 / Delta Electronics
- 今日重點：未見新增設廠公告；產業面新增台灣 AIDC 供電壓力，與台達資料中心電源、樓宇自動化、冷卻與能源管理業務高度相關。
- 代表查詢：台達 AI資料中心 電源 美國製造、Delta Electronics data center power factory、Delta Thailand AI server power digital twin。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：資料中心園區需同步規劃高壓供電、備援、冷卻、能源管理與智慧製造驗證空間。

### 9. 仁寶電腦 / Compal
- 今日重點：未見重大新動態。
- 代表查詢：仁寶 AI ODM HUMAIN factory、Compal Poland automotive electronics、Compal AI infrastructure manufacturing。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：追問中東 AI ODM 合作的組裝地、維保地與機櫃電力／冷卻規格。

### 10. 研華 / Advantech
- 今日重點：未見重大新動態。
- 代表查詢：研華 Edge AI Europe service center、Advantech Edge AI factory Europe、Advantech Eindhoven Munich innovation center。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：Edge AI 與 Physical AI 應對接園區智慧製造、半導體設備與機器人驗證場域。

### 11. 廣運集團 / Kenmec
- 今日重點：未見重大新動態。
- 代表查詢：廣運 NEURA Robotics Europe、Kenmec automated warehouse factory investment、Kenmec robotics system integration Europe。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：追蹤歐洲智慧物流、倉儲自動化與機器人整合需求。

### 12. 祥儀企業 / Shayang Ye Industrial
- 今日重點：未見重大新動態。
- 代表查詢：祥儀 齒輪箱 歐洲 客戶、Shayang Ye gearbox AGV robot Europe、Shayang Ye motor investment。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：適合作為小型傳動、AGV 與服務型機器人供應鏈訪談題。

### 13. 和椿科技 / Aurotek
- 今日重點：未見重大新動態。
- 代表查詢：和椿 機器人 代理 歐洲、Aurotek robotics automation Germany、Aurotek smart factory CNC MES。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：應追蹤代理品牌技術整合是否延伸至海外服務或系統整合據點。

### 14. 友嘉集團 / FFG
- 今日重點：未見重大新動態。
- 代表查詢：友嘉 MAG Pfiffner Europe investment、FFG machine tools Germany Italy factory、Fair Friend Group aerospace automotive machining。
- 海外設廠／國際布局訊號：無新增。
...
### 16. 群光電子 / Chicony
- 今日重點：未見重大新動態。
- 代表查詢：群光 捷克廠 美國機器人、Chicony Czech factory camera module、Chicony robotics startup supply chain。
- 海外設廠／國際布局訊號：無新增。
- 對 TEEMA 意涵：實體 AI 影像模組與捷克在地製造需追蹤客戶名稱與交付地。

### 17. 華城電機 / Fortune Electric
- 今日重點：9/14 經濟日報「南亞攜華城」已收錄；本輪無新直接來源。
- 代表查詢：華城 AI資料中心 變壓器 美國 日本、Fortune Electric transformer data center orders、Fortune Electric U.S. grid transformer factory。
- 海外設廠／國際布局訊號：無新增公告；既有訊號為美日 AI 電力訂單與變壓器接單能見度。
- 對 TEEMA 意涵：最需訪談北美服務配置、交期瓶頸、油浸／乾式變壓器供應商與電網標準認證。
...
| 語言 | 代表查詢 | 結果與排除 |
| --- | --- | --- |
| 中文 | 鴻海／台達／光寶／華城 AI伺服器 設廠 投資 2026/09/15 | 找到台灣 AIDC 用電政策與產業鏈報導；核心企業無新增原廠公告。 |
| 英文 | Foxconn / Delta / LITEON / Fortune Electric factory investment AI data center September 2026 | 未見 9/15-9/16 新直接設廠公告；排除舊聞與列表頁。 |
| 德文 | Rechenzentrum KI Stromnetz Baugenehmigung Investition September 2026 | 無新增可直接寫入且未重複之 ICT 製造設廠新聞。 |
...
- Step 1 聯邦法規／補貼／合規：本輪無新增美國補貼或 CHIPS 直接案件。
- Step 2 州別選址矩陣：無新增州別設廠資料；延續追蹤 Texas、Ohio、California、West Virginia 之大型負載與資料中心電力訊號。
- Step 3 第三方輔導與決策程序：台灣 AIDC 用電報導可納入場址評估清單，提醒海外園區需在初期同步蒐集電力容量、接電期程、備援、用水、冷卻與需求響應方案。

## 九、人工複核清單

1. 東元與 Conduit Pharmaceuticals 相關合資 AI 資料中心公司：確認官方公告、資本結構、地點、用電容量與是否涉及 TECO 電力設備供應。
2. 華城／南亞美日 AI 電力訂單：確認客戶、出貨時程、北美服務據點、變壓器產能與認證。
